...
class paypal_class {
   ...
   function submit_paypal_post() {
	  ...
	  echo "<div style=\"min-height:66px; width:900px; margin:0 auto;\"><img src=\"sys_images/paypal_logo.gif\" /></div>\n";
      echo "<div style=\"text-align:center; background:url(sys_images/header_bg.gif) repeat-x left top; min-height:66px; padding-top:50px;\"><h2>Por favor espera, tu orden esta siendo procesada.";
      echo " Estas siendo redirigido a Paypal.</h2></div>\n";
      ...
      echo "<center><br/><br/>Si no eres dirigido automaticamente a ";
      echo "paypal en 5 segunos haz click en el boton...<br/><br/>\n";
      echo "<input type=\"submit\" value=\"Click aqui\"></center>\n";
